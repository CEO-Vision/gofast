...
<div id="comment-content-<?php print $comment->cid; ?>" class="panel panel-default <?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <div class="panel-heading">
    <div class="forum-posted-on">
      ...
      ?>
        <span style="margin-left: 10px;"><strong><?php print t("Edited by") . " " . theme('user_picture', array('account' => $edit_user, "dimensions" => "12")) . " " . gofast_user_display_name($edit_user) . "</strong> : " . format_date($comment->field_edited_timestamp[LANGUAGE_NONE][0]['value']);?></span>
      <?php
        }
      ?>
