...
<section id="<?php print $block_html_id; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?> style="border:none;padding:0px;">
    <div id='search_tab'>
     <ul class="nav nav-tabs nav-justified" role="tablist">
          ...
          <li role="presentation" ><a id="searchtab_saved" href="#search_saved" aria-controls="search_saved" role="tab" data-toggle="tab"><?php print t("My saved searches", array(), array("context" => "gofast:gofast_search")); ?></a></li>
     </ul>
          ...
          <div role="tabpanel" class="tab-pane active" id="search_current">
            <div class="container container-number-results" style="float:left;width:80%;">             
                ...
                <div style="float:right;position:relative;">
                    <a style="padding:4px;color:#2980b9;display:none;" id="addToCart" type="button" class="btn btn-default btn-sm fa fa-lg fa-bars dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"></a>
                    <ul class="dropdown-menu dropdown-menu-right gofast-dropdown-menu">
                        <li>
                            <a onClick='Gofast.search.getAlfrescoItemForAddToCart()' class="btn btn-sm center-block sidebar-items" aria-labelledby="addToCart">
                                <div class="list-items-icons"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></div>
                                <p><?php echo t('Add search results to cart', array(), array('context' => 'gofast:gofast_search')); ?></p>
                            </a>
                        </li>
                    </ul>
                    <script>
                    ...
                    <a style="padding:4px;color:#2980b9; " type="button" class="btn btn-default ctools-use-modal fa fa-lg fa-save" title='<?php print t("Save this search", array(), array("context" => "gofast:gofast_search")); ?>' href="/modal/nojs/search/save"></a>
                </div>
        ...
        <div class="facet-collapsible-wrapper" style="" id="facetapi_search_filters">
            <ul class="facetapi-gofast-facetapi-links facetapi-collapsible">
                ...
                <div style="margin:5px;">
                    ...
                    <?php $help_strict_search = t("A strict search means all keywords are mandatories ( except if they start by - ) and they must be exactly the same as on the document", array(), array("context" => "gofast:gofast_search")); ?>
                    <span style='' href="#" title="<?php echo t("Strict search", array(), array("context" => "gofast:gofast_search")); ?>" ><?php echo t("Strict search", array(), array("context" => "gofast:gofast_search")); ?></span> <i title="<?php echo $help_strict_search; ?>" class="fa fa-question-circle" style=" color: #777;cursor:pointer;"></i>
                </div>
                   <!-- end strict search -->
