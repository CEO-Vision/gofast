...
<div id="fullscreen-node">
  <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="content well well-sm contact-node"<?php print $content_attributes; ?>>
      ...
      $hbar = "<br><div style='background:black; height:1px; width: 50%; margin: 0 auto; '></div><br>";
      if(!empty($content['body'])) {
          print '<div class="field-contact-body">'.render($content['body']).'</div>'.$hbar; 
      }
        
        gofast_contacts_replace_display($content);
