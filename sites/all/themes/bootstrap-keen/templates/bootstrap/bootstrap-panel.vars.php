 ...
 */
function bootstrap_keen_preprocess_bootstrap_panel(array &$variables) {
  ...
  if (isset($element['#collapsible'])) {
    ...
    if ($element['#keen-accordion']) { //[GOFAST-6837] accordions
        $attributes['class'] = 'accordion accordion-solid accordion-toggle-plus mt-2 mb-2';
        unset($attributes['id']);
    }
  }
  ...
  if (!isset($attributes['id']) && !$element['#keen-accordion']) {
 ...
 */
function bootstrap_keen_process_bootstrap_panel(array &$variables) {
