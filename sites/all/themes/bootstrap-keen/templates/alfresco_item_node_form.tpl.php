    ...
    <div class="GofastForm__Field GofastForm__Field--file">
      ...
      <?php else : ?>
        <ul class="nav nav-tabs" id="alfresco_item_tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="download_file" data-toggle="tab" href="#downloadFile" aria-controls="downloadFile">
              <span class="nav-text"><?php echo t('Download a file', array('context' => 'gofast:gofast_cmis')); ?></span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="create_from_template" data-toggle="tab" href="#createFromTemplate" aria-controls="createFromTemplate">
              <span class="nav-text"><?php echo t('Create from template', array('context' => 'gofast:gofast_cmis')); ?></span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="create_an_empty_file" data-toggle="tab" href="#createAnEmptyFile" aria-controls="createAnEmptyFile">
        ...
        <div class="tab-content p-4" id="alfresco_item_tabContent">
          <div class="tab-pane fade active show" id="downloadFile" role="tabpanel" aria-labelledby="download_file"><?php echo render($form['group_vertical_tab_input_file']['group_upload_file']['reference']); ?></div>
          <div class="tab-pane fade" id="createFromTemplate" role="tabpanel" aria-labelledby="create_from_template">
            <?php echo render($form['group_vertical_tab_input_file']['group_template_file']['ztree_templates']);
            echo render($form['group_vertical_tab_input_file']['group_template_file']['templates']); ?></div>
          <div class="tab-pane fade" id="createAnEmptyFile" role="tabpanel" aria-labelledby="create_an_empty_file"><?php echo render($form['group_vertical_tab_input_file']['group_empty_file']['empty_template']); ?></div>
        </div>
      <?php endif ?>
    </div>
