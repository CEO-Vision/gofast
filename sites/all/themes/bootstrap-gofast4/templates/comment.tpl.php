...
<div id="comment-content-<?php print $comment->cid; ?>" class="panel panel-default <?php print $classes; ?>" <?php print $attributes; ?>>
  ...
  <div class="panel-heading">
    <div class="forum-posted-on">
      ...
      <?php
        if(isset($comment->field_edited_by[LANGUAGE_NONE][0]['value']) && $comment->field_edited_by[LANGUAGE_NONE][0]['value'] > 0){
            $edit_user = user_load($comment->field_edited_by[LANGUAGE_NONE][0]['value']);
      ?>
        <span style="margin-left: 10px;"><strong><?php print t("Edited by") . " " . theme('user_picture', array('account' => $edit_user, "dimensions" => "12")) . " " . gofast_user_display_name(user_load($edit_user)) . "</strong> : " . format_date($comment->field_edited_timestamp[LANGUAGE_NONE][0]['value']);?></span>
      <?php
        }
      ?>
  ...
  <div class="forum-post-wrapper row" style="margin-left: 0px; margin-right: 0px;">
    <div class="forum-post-panel-sub col-md-2">
    ...
    <div class="forum-post-panel-main col-md-10">
