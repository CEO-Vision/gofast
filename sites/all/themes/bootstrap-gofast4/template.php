 ...
 * @return type
 */
function bootstrap_gofast4_select($variables) {
  $element = $variables['element'];
  element_set_attributes($element, array('id', 'name', 'size'));
  _form_set_class($element, array('form-select'));

  return '<select' . drupal_attributes($element['#attributes']) . '>' . bootstrap_gofast4_form_select_options($element) . '</select>';
}

function bootstrap_gofast4_form_select_options($element, $choices = NULL) {
  if (!isset($choices)) {
 ...
 * @return type
 */
function bootstrap_gofast4_menu_link__main_menu($variables) {
  $element = $variables['element'];
  $sub_menu = '';
  global $user;
...
function bootstrap_gofast4_breadcrumb($variables) {
 ...
 */
function bootstrap_gofast4_textfield($variables) {
  $element = $variables['element'];
 ...
 */
function bootstrap_gofast4_bootstrap_search_form_wrapper($variables) {
 ...
 * @ingroup themeable
 */
function bootstrap_gofast4_facetapi_title($variables) {
 ...
 */
function bootstrap_gofast4_apachesolr_sort_list($variables) {
 ...
 */
function bootstrap_gofast4_links__locale_block(&$variables) {
...
function bootstrap_gofast4_preprocess_node(&$variables) {
  $variables['author_pane'] = theme('gofast_forum_simple_author_pane', array('context' => $variables['node']));
}

function bootstrap_gofast4_preprocess_comment(&$variables) {
  // Forum permalink.
 ...
 */
function bootstrap_gofast4_username($variables) {
 ...
 */
function bootstrap_gofast4_menu_local_tasks_alter(&$data, $router_item, $root_path) {
 ...
 * @ingroup themeable
 */
function bootstrap_gofast4_image_style($variables) {
 ...
 */
function bootstrap_gofast4_menu_link__user_menu(array $variables) {
  $element = $variables['element'];
  $sub_menu = '';
  $profile = NULL;
 ...
 * @ingroup themeable
 */
function bootstrap_gofast4_password($variables) {
  $element = $variables['element'];
...
function bootstrap_gofast4_preprocess_html(&$variables) {
...
function bootstrap_gofast4_preprocess_views_view_table(&$variables) {
 ...
 */
function bootstrap_gofast4_theme_registry_alter(&$theme_registry) {
...
function bootstrap_gofast4_facetapi_deactivate_widget($variables) {
...
function bootstrap_gofast4_preprocess_block(&$variables) {
