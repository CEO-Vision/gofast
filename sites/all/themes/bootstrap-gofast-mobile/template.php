 ...
 * @return type
 */
function bootstrap_gofast_mobile_menu_link__main_menu($variables)
{
 ...
 * @return type
 */
function bootstrap_gofast_mobile_select($variables) {
  $element = $variables['element'];
  element_set_attributes($element, array('id', 'name', 'size'));
  _form_set_class($element, array('form-select'));

  return '<select' . drupal_attributes($element['#attributes']) . '>' . bootstrap_gofast_mobile_form_select_options($element) . '</select>';
}

function bootstrap_gofast_mobile_form_select_options($element, $choices = NULL) {
  if (!isset($choices)) {
...
function bootstrap_gofast_mobile_breadcrumb($variables) {
 ...
 */
function bootstrap_gofast_mobile_textfield($variables) {
  $element = $variables['element'];
 ...
 */
function bootstrap_gofast_mobile_bootstrap_search_form_wrapper($variables) {
 ...
 * @ingroup themeable
 */
function bootstrap_gofast_mobile_facetapi_title($variables) {
  return t('@title', array('@title' => ucwords(drupal_strtolower($variables['title']))));
}
 ...
 */
function bootstrap_gofast_mobile_apachesolr_sort_list($variables) {
 ...
 */
function bootstrap_gofast_mobile_links__locale_block(&$variables) {
...
function bootstrap_gofast_mobile_preprocess_node(&$variables) {
  $variables['author_pane'] = theme('gofast_forum_simple_author_pane', array('context' => $variables['node']));
}

function bootstrap_gofast_mobile_preprocess_comment(&$variables) {
  // Forum permalink.
 ...
 */
function bootstrap_gofast_mobile_username($variables) {
 ...
 */
function bootstrap_gofast_mobile_menu_local_tasks_alter(&$data, $router_item, $root_path) {
 ...
 * @ingroup themeable
 */
function bootstrap_gofast_mobile_image_style($variables) {
 ...
 */
function bootstrap_gofast_mobile_menu_link__user_menu(array $variables){
  $element = $variables['element'];
  $sub_menu = '';
  $profile = NULL;
 ...
 * @ingroup themeable
 */
function bootstrap_gofast_mobile_password($variables) {
  $element = $variables['element'];
...
function bootstrap_gofast_mobile_preprocess_html(&$variables) {
  ...
  $element = array(
    'rel' => 'shortcut icon',
    'href' => 'sites/all/themes/bootstrap-gofast-mobile/favicon.ico',
  );
  drupal_add_html_head_link($element);
}

//function bootstrap_gofast_mobile_menu_link__menu_mobile_menu(&$variables) {
//  $element = $variables['element'];
//  if ($element['#below']) {
//    unset($element['#below']['#theme_wrappers']);
//    $gofast_mobile_menu = '<div class="collapse"><ul class="nav navbar-nav">' . drupal_render($element['#below']) . '</ul></div>';
//    $variables['gofast_collapse_button'] = '<button type="button" data-toggle="collapse" data-target=".collapse" id="gofast_togglebar">
//          <span class="sr-only">Toggle navigation</span>
//          <span class="icon-bar"></span>
//          <span class="icon-bar"></span>
//          <span class="icon-bar"></span>
//        </button>';
//    return $gofast_mobile_menu;
//  }
//}
 ...
 */
function bootstrap_gofast_mobile_theme_registry_alter(&$theme_registry) {
