...
if ($needs_wrapping_element): ?>
  ...
  <span class="<?php print $flag_wrapper_classes; ?>">
    <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="btn-sm <?php print $flag_classes ?>" rel="nofollow"><span class="fa fa-cart-arrow-down"></span> <?php print $link_text; ?></a><!--<span class="flag-throbber">&nbsp;</span>-->
      <?php else: ?>
