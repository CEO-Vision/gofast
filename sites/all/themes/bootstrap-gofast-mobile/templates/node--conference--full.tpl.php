<div id="fullscreen-node">
    <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
        ...
        <div id="breadcrumb-container-buton-mobile" class="breadcrumb-alt" style="top: 5px;" ></div>
        <script>
          ...
          jQuery.get('/gofast/node-actions/' + <?php echo $node->nid; ?>, function (data) {
              jQuery(".breadcrumb-alt").html(data);
              jQuery("#breadcrumb-alt-actions > button#toggle-fitscreen").remove();
          });
        </script>
        <?php
