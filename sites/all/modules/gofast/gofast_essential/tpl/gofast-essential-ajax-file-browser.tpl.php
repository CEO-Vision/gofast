            ...
            <ul class="dropdown-menu">
             <div class="navi navi-hover navi-link-rounded text-truncate min-w-250px">
              ...
              <?php if (gofast_essential_is_essential()) { ?>
                <li class="navi-item"><?php print gofast_dropdown_link(t('Document(s)', array(), array('context' => 'gofast:ajax_file_browser')), '/modal/nojs/node/add/alfresco-item#createFromTemplate', 'add_alfresco_item', 'ctools-use-modal add-alfresco_item navi-link', 'fa fa-file', array('onClick' => "Gofast.ITHit.attachInputEvents()")); ?></li>
              <?php } else { ?>
          ...
          <div id="" class="btn-group">
            ...
            <ul class="dropdown-menu">
             <div class="navi navi-hover navi-link-rounded text-truncate min-w-250px">
              ...
              print '<li class="navi-item">' .  gofast_dropdown_link(t('Compress', array(), array('context' => 'gofast:ajax_file_browser')), '/modal/nojs/compress-files', 'compress_files', 'ctools-use-modal compress-files', 'fa fa-file-archive-o n-color', $attr) . '</li>';
    ...
    <div id="file_browser_tree_and_files" class="overflow-hidden">
      <?php if(!gofast_essential_is_essential()):?>
        <div id="file_browser_full_tree_container" class="pl-4 border border-1 bg-white min-h-150px">
          <div id="file_browser_full_tree">
            <ul id="file_browser_full_tree_element" class="ztree overflow-auto"></ul>
          </div>
        </div>
        <?php endif;?>
      <div id="mobile_file_browser_full_files_container" class="border border-1 bg-white min-h-150px">
    ...
    jQuery(document).ready(function() {
      ...
      jQuery("#file_browser_full_tree_container").resizable({
        ...
        resize: function(e, ui) {
          ...
          jQuery("#mobile_mobile_file_browser_full_files_container").width(jQuery("#file_browser_full_container").width() - jQuery("#file_browser_full_tree_container").width());
          jQuery("#mobile_mobile_file_browser_full_files_container table").width(jQuery("#mobile_file_browser_full_files_container").width() - 20);
          // jQuery("#mobile_file_browser_full_files_container").css("margin-left", jQuery("#file_browser_full_tree_container").width());
        }
      });
    });
  </script>
...
?>
  <script>
    jQuery(document).ready(function() {
      ...
      jQuery("#mobile_file_browser_full_files_container").resizable({
        ...
        resize: function(e, ui) {
          ...
          jQuery("#file_browser_full_files_table").height(jQuery("#mobile_file_browser_full_files_container").height());
          jQuery("#file_browser_full_tree_container").height(jQuery("#mobile_file_browser_full_files_container").height());
          jQuery("#file_browser_full_tree_element").height(jQuery("#mobile_file_browser_full_files_container").height());
        }
      });
      ...
      jQuery("#file_browser_full_tree_container").resizable({
        ...
        resize: function(e, ui) {
          //Also resize file block
          jQuery("#mobile_file_browser_full_files_container").width(jQuery("#file_browser_full_container").width() - jQuery("#file_browser_full_tree_container").width());
          jQuery("#mobile_file_browser_full_files_container table").width(jQuery("#mobile_file_browser_full_files_container").width() - 20);
          // jQuery("#mobile_file_browser_full_files_container").css("margin-left", jQuery("#file_browser_full_tree_container").width());
        }
      });
    });
...
<style>
  @media screen and (max-width: 1024px) {
    #file_browser_full_files_header, #file_browser_full_files_table  tbody  tr{
