                                            ...
                                            <td valign="top" style="color: #666666; font-family: Arial; font-size: 13px; font-weight: normal; line-height: 150%;">
                                                <?php 
                                                    if(strlen($comment_title) > 0){
                                                      ...
                                                      print $is_digest ? $author_name : t('!author added the comment "!title" on', array('!author' => $author_name, '!title' => $comment_title), $l);
                                                    }else{
                                                       print $is_digest ? $author_name : t('!author added a comment on', array('!author' => $author_name), $l);
                                                    }
                                                ?>
                                        ...
                                        <?php if ($is_digest) : ?>
                                            <tr>
                                                <td valign="bottom" style="color: #666666; font-family: Arial; font-size: 12px; font-weight: normal; line-height: 150%; padding-top:1px;">
                                                    <?php print t('added a comment', array(), $l); ?>
                                                </td>
                                            </tr>                     
                                        <?php endif; ?>
                                    </table>
                            ...
                            <tr>
                                <td valign="top">
                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="font-size:12px;">
                                        ...
                                        <tr>
                                            <?php if(!$comment_reply_size): ?> 
                                                <td width="75">
                                            <?php else: ?>
                                                <td width="<?php echo $comment_reply_size; ?>"> 
                                            <?php endif; ?>
