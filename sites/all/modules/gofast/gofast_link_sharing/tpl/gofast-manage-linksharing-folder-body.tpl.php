                        ...
                        <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-left:0;word-break:break-word;">
                                <?php if (isset($is_author)):?>
                                    <div style="font-family:Poppins, Candara, 
                                 Helvetica, Arial, sans-serif;font-size:18px;
                                    font-weight:600;line-height:1;
                                    text-align:left;color:#000000;"><?= t
                                      ('Hello', array(), $l) . " " . $author_name 
                                      ?></div>
                                <?php endif;?>
                              <?php if (!isset($is_author)):?>
                                  <div style="font-family:Poppins, Candara,  
                                  ...
                                  line-height:1; text-align:left;color:#000000;"><?= t('Hello', array(), $l) . " " . $recip_name ?></div>
                              <?php endif;?>
                            </td>
                        </tr>
                        </tbody>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class=""
       role="presentation" style="width:992px;" width="992" bgcolor="white">
    <tr>
            ...
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:10px;padding-left:10px;padding-top:0px;text-align:center;">
              <?php if (!isset($is_author)) : ?>
                  ...
                  <table role="presentation" border="0" cellpadding="0"
                         cellspacing="0">
                      <tr>
                          <td class="" style="width:883.8px;"><![endif]-->
                  <div class="mj-column-per-90 mj-outlook-group-fix"
                      ...
                      <div class="mj-column-per-10 mj-outlook-group-fix"
                           style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:10%;">
                          <table border="0" cellpadding="0" cellspacing="0"
                      ...
                      <!--[if mso | IE]></td>
                      <td style="vertical-align:middle;width:613px;">
                      <![endif]-->
                      <div class="mj-column-per-90 mj-outlook-group-fix"
                           style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:90%;">
                          <table border="0" cellpadding="0" cellspacing="0"
                                 role="presentation" width="100%">
                              <tbody>
                              <tr>
                              ...
                              font-weight:400;line-height:1;text-align:left;
                              color:#000000;"><?= $author_name . t(" has Shared a folder with you
        ...
        <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:10px;padding-left:10px;padding-top:0px;text-align:center;">
                ...
                <table role="presentation" border="0" cellpadding="0"
                       cellspacing="0">
                    <tr>
                        <td class="" style="vertical-align:top;width:883.8px;">
                <![endif]-->
                <div class="mj-column-per-90 mj-outlook-group-fix"
                     style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0"
                           role="presentation"
                           style="background-color:#de6502;border-radius:5px;vertical-align:top;"
                           width="100%">
                        <tbody>
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1;text-align:left;color:white;">
                                    <table border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="<?= $base_url . '/' . drupal_get_path('module', 'gofast_mail_queue') . '/icon/' . 'share-white.png' ?>"
                                                     alt="<?= t("Information Icon", [], ["context" => "gofast:gofast"]) ?>"
                                                     width="18"/>
                                            </td>
        ...
        <tr>
            <td style="direction:ltr;font-size:0px;padding:0;padding-bottom:10px;padding-left:10px;padding-top:0px;text-align:center;">
                ...
                <table role="presentation" border="0" cellpadding="0"
                    ...
                    <tr>
                        <td class=""
                            style="vertical-align:middle;width:883.8px;">
                <![endif]-->
                <div class="mj-column-per-90 mj-outlook-group-fix"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td align="left"
                                style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:5px;word-break:break-word;">
                                <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:1;text-align:left;color:#000000;">
                                    <table border="0" cellpadding="0"
                                           cellspacing="0" role="presentation"
                                           style="vertical-align:middle;">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="<?= $folder_information->url ?>"
                                                   style="text-decoration: none;"
                                                   color="#337ab7">
                                                    <i class="fa-2x fa fa-folder"></i>
                                                  <?= $folder_information->title ?></a>
                        ...
                        <tr>
                            <td align="center" vertical-align="middle"
                                ...
                                <table border="0" cellpadding="0"
                                    ...
                                    <tbody>
                                    <tr>
                                        <td align="center" bgcolor="#159992"
                                            role="presentation"
                                            style="border:none;border-radius:5px;cursor:auto;mso-padding-alt:10px 25px;background:#159992;"
                                            valign="middle">
                                            <a href="<?= $download ?>"
                                               style="display:inline-block;background:#1BC5BD;color:white;font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:5px;"
                                               target="_blank"><?= t('Download folder here', [], $l) ?></a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            <tr>
                <td style="direction:ltr;font-size:0px;padding:0;padding-left:10px;padding-top:10px;text-align:center;">
                    ...
                    <table role="presentation" border="0" cellpadding="0"
                        ...
                        <tr>
                            <td class=""
                                style="vertical-align:top;width:883.8px;">
                    <![endif]-->
                    <div class="mj-column-per-90 mj-outlook-group-fix"
                         style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                        <table border="0" cellpadding="0" cellspacing="0"
                               role="presentation"
                               style="background-color:#F3F6F9;border-radius:5px;vertical-align:top;"
                               width="100%">
                            <tbody>
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1;text-align:left;color:#3699ff;">
                                        <table border="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="<?= $base_url . '/' . drupal_get_path('module', 'gofast_mail_queue') . '/icon/' . 'scroll-solid-primary.png' ?>"
                                                         alt="<?= t("Information Icon", [], ["context" => "gofast:gofast"]) ?>"
                                                         width="18"/>
                                                </td>
                                                <td><span style="color: #3699ff; font-size: 18px; font-weight: 600;">&nbsp;<?= t('Message', [], $l) ?>
                                </span></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1;text-align:left;color:#3699ff;">
                                        <table border="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span style="color: #3699ff; font-size: 18px; font-weight: 600;">&nbsp;<?= t("Other recipients", [], ["context" => "gofast:gofast_link_sharing"]) ?></span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <td align="left"
                                            ...
                                            <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:1;text-align:left;color:#000000;">
                                                <table border="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img src="<?= $base_url . '/' . drupal_get_path('module', 'gofast_mail_queue') . '/icon/' . 'arrow-right-solid-muted.png' ?>"
                                                                 width="14"/>
                                                        <td>
                                                            <a href="mailto:<?= $mail ?>"
                                                               style="color: #337ab7; text-decoration: none;">&nbsp;<?= $mail ?></a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
        ...
        <tr>
            <td style="direction:ltr;font-size:0px;padding:0;padding-left:10px;padding-top:10px;text-align:center;">
                ...
                <div class="mj-column-per-90 mj-outlook-group-fix"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0"
                           role="presentation"
                           style="background-color:#337ab7;border-radius:5px;vertical-align:top;"
                           width="100%">
                        <tbody>
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:18px;font-weight:600;line-height:1;text-align:left;color:white;">
                                    <table border="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td>
                                                <img src="<?= $base_url . '/' . drupal_get_path('module', 'gofast_mail_queue') . '/icon/' . 'info-circle-solid-white.png' ?>"
                                                     alt="<?= t("Information Icon", [], ["context" => "gofast:gofast"]) ?>"
                                                     width="18"
                                                     style="vertical-align: middle;"/>
                                            </td>
                                            <td>
                                                <span style="color: #ffffff; font-size: 18px; font-weight: 600;">&nbsp;<?= t("Informations", [], ["context" => "gofast"]) ?></span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="mj-column-per-90 mj-outlook-group-fix"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td align="left"
                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Poppins, Candara, Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;line-height:1;text-align:left;color:#000000;"><?= t('If you want, you can download the file and edit it.', [], $l) ?> <?= $expiry_msg ?></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
