...
<div class="gutter-b">
  <div>
    <?php $members_filter_form = drupal_get_form('gofast_og_member_filter_form');
    print drupal_render($members_filter_form); ?>
  </div>
</div>
<div class="card card-custom gutter-b">
  <div class="card-header">
    <div class="card-title">
      ...
      <a class="btn btn-sm btn-icon btn-light-primary ml-2" style="color:#3699FF" onmouseover="displayPanelTip(this)" onmouseout="hidePanelTip(this)">
    ...
    <div class="card-title">
      ...
      <div class="panel panel-primary" style="width: 500px; position: absolute; z-index: 10; display: none;">
        ...
        <div class="panel-body" style="font-size: 12px; color:#525252; font-weight: normal;">
          <strong><?php print t('Can :', array(), array('context' => 'gofast:gofast_og')); ?></strong><br />
          <ul>
            <?php if ($create_sub_space_ro) {
              print "<li>" . t('Create a sub space', array(), array('context' => 'gofast:gofast_og')) . "</li>";
            } ?>
