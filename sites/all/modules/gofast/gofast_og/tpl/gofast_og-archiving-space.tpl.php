<div id="archive_space_modal_process_container">
  <div class="panel panel-default">
    <div class="panel-body">
      <div id="archive_step_1_1">
...
function checkState(){ 
    ...
    $.get(window.location.origin + "/space/<?php echo $space_node->nid; ?>/archive/status", function(response){
