  ...
  <tr>
    <td>
      <table width="98%" cellpadding="0" cellspacing="0" style="padding-left:10px; padding-right: 10px; margin-top:20px;">
        <tr>
              <?php print t('A user "@role" sent you a message because you are administrator of space ', array("@role" => t(GOFAST_ROLE_BUSINESS_ADMIN_VALUE, array(), array("context" => "gofast"))), $l); ?>            <a href='<?php print $node_link; ?>'>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#f5f5f5" style=" background-color: #f5f5f5; border-bottom: 1px solid;  border-color: #bce8f1;">
              <tr>
                <td style="padding-left:15px;">
                  <h4 style="margin-top: 10px; margin-bottom: 10px; color: #31708f;"><?php print t('User', array(), array("context" => "gofast")); ?></h4>
                </td>
              </tr>
      </table>
    </td>
