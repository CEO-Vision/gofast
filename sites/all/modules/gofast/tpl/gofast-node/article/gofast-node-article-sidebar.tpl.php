...
<script type='text/javascript'>
  jQuery(document).ready(function() {
    var manageLocations = "<?= isset($node->book["bid"]) ? "false" : "true" ?>";;
    Gofast.gofast_right_block_breadcrumb(manageLocations);
