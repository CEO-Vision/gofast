...
if (isset($popup_variables['delegated']) && $popup_variables['delegated'] == 'true') {
  ...
  print '<span class="xeditable-trigger-2 btn btn-xs btn-primary" alt="' . t('Edit', array(), array('context' => 'gofast')) . '"><span class="glyphicon glyphicon-pencil" ></span> ' . t('Edit', array(), array('context' => 'gofast')) . '</span>';
} else {
