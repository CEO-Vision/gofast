...
?>
    <style>
        ...
        .GofastForbidden .card:hover {
            box-shadow: rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;
            transform: translateY(-.5rem);
        }

        .GofastForbidden .card-toolbar {
            transition: all .3s ease-in-out;
        }

        .GofastForbidden .card-toolbar:hover {
            transform: scale(1.1);
        }
    </style>
    <div id="kt_content" class="container-fluid h-100 py-0">
        <div id="kt_subheader" class="subheader mt-4 pt-6 pt-lg-8 subheader-transparent d-flex flex-column align-items-start">
            <div class="block-title font-size-h1 font-weight-bold mb-4">
                <?php print t("Unfortunately, you do not have access to this page.", array(), array('context' => 'gofast_error')); ?>
            </div>
        ...
        <div class="d-flex flex-column-fluid">
            <div class="container GofastForbidden">
