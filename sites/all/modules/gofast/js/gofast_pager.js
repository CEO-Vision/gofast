  ...
  if(jQuery(listElement).prop("tagName") !== 'TBODY' && jQuery(listElement).prop("tagName") !== 'UL' ){
    ...
    if(numPages > 1){ // only dispaly pager if nb Pages > 1
      ...
      if (settings.showFirstLast) {
        jQuery('<li><a href="#" class="first_link" aria-label="First" ><span aria-hidden="false">'+ Drupal.t("« first") +'</span></a></li>').appendTo(pager);
      }

      if (settings.showPrevNext) {
        jQuery('<li><a href="#" class="prev_link" aria-label="Previous" ><span aria-hidden="false">'+ Drupal.t("< previous") +'</span></a></li>').appendTo(pager);
      }
      ...
      if (settings.showPrevNext) {
        jQuery('<li><a href="#" class="next_link" aria-label="Next" ><span aria-hidden="false">'+ Drupal.t("next >") +'</span></a></li>').appendTo(pager);
      }

      if (settings.showFirstLast) {
        jQuery('<li><a href="#" class="last_link" aria-label="Last" ><span aria-hidden="false">'+ Drupal.t("last »") +'</span></a></li>').appendTo(pager);
      }
