...
*/
public class Gf_add_link_nodeImpl extends AbstractGf_add_link_nodeImpl {
	String token;
	@Override
	protected void executeBusinessLogic() throws ConnectorException{
		...
		try {
			...
			String json;
			if(getInternal()) {
				json = "{\"field_target_link\": \"["+getLink()+"]\", \"nid\" : \""+getNid()+"\"}";
			}else {
				json = "{\"field_external_page_url\": \"["+getLink()+"]\", \"nid\" : \""+getNid()+"\"}";
			}
