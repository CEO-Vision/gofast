...
*/
public class Gf_archive_nodeImpl extends AbstractGf_archive_nodeImpl {
	String token;
	@Override
	protected void executeBusinessLogic() throws ConnectorException{
		...
		try {								
			String url_edit_node = "http://localhost/api/node/archive";
			...
			//String json = "{\"comment_message\": "+getComment_message()+", \"nid\" : \""+getNid()+"\", \"create_comment\" : "+getCreate_comment().toString()+" }";
			String json = "{\"nid\" : \""+getNid()+"\", \"unarchive\" : \""+getUnarchive().toString()+"\" }";
