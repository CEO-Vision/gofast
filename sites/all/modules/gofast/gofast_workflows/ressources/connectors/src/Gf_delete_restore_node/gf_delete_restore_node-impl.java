...
*/
public class Gf_delete_restore_nodeImpl extends AbstractGf_delete_restore_nodeImpl {
	String token;
	@Override
	protected void executeBusinessLogic() throws ConnectorException{
		...
		try {								
			String url_edit_node = "http://localhost/api/node/status";
			...
			String json = "{\"nid\" : \""+getNid()+"\", \"restore\" : \""+getRestore().toString()+"\" }";
