...
*/
public class Gf_create_node_from_templateImpl extends AbstractGf_create_node_from_templateImpl {
	String token;
	@Override
	protected void executeBusinessLogic() throws ConnectorException{
		...
		try {		
			...
			String url_edit_node = "http://localhost/api/node/node";		
			...
			request_post.addHeader("Content-Type", "multipart/form-data");
			request_post.addHeader("token", token);
			String json = "{\"title\" : \""+getTitre()+"\" ,\"type\" : \""+getType()+"\", \"locations\": "+json_string_locations+", \"template_nid\" : \""+getNid()+"\", \"keep_tags\": \""+keep_tags+"\"}";
