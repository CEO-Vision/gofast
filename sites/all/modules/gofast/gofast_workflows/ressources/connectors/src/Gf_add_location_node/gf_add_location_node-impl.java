...
*/
public class Gf_add_location_nodeImpl extends AbstractGf_add_location_nodeImpl {
	String token;
	@Override
	protected void executeBusinessLogic() throws ConnectorException{
		...
		try {		
			...
			String url_edit_node = "http://localhost/api/node/locations";
			...
			String json = "{\"locations\": "+json_string_locations+", \"nid\" : \""+getNid()+"\", \"delete\" : "+getDelete()+" }";
