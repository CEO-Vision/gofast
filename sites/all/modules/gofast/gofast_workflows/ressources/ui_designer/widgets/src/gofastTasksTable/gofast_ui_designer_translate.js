		...
		return function (item) {
			...
			var localizations = {
				"en" : {
					...
					"label.free_to_take" : "This task can be performed freely by authorized users",
					...
					"label.process_has_no_deadline" : "This process has no deadline",
				...
				"fr" : {
					...
					"label.free_to_take" : "Cette tâche peut librement être prise par les utilisateurs autorisés",
					...
					"label.process_has_no_deadline" : "Ce processus n'a pas de date limite",
				...
				"nl" : {
					...
					"label.free_to_take" : "Deze taak kan vrij worden uitgevoerd door bevoegde gebruikers",
					...
					"label.process_has_no_deadline" : "Dit proces heeft geen deadline",
