      ...
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#f5f5f5" style=" background-color: #f5f5f5; border-bottom: 1px solid;  border-color: #ddd;">
        <tr>  
          <td style="padding-left:15px;">
            <h4 style="margin-top: 10px; margin-bottom: 10px; color: #31708f;"><?php print t('Retention',array(), array('context'=> 'gofast', 'langcode' => $user_lang)); ?></h4>
          </td>
        </tr>
    </table>
    </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding-left:10px; font-size: 14px; color: #333; padding-top:10px; padding-right: 10px; padding-bottom:10px; display: inline-block;">
           <?php echo t('The retention date for those documents', array(), array('context'=> 'gofast', 'langcode' => $user_lang)) ?>        
           <?php echo t('will expire <strong>'.$expired_date.'</strong>', array(), array('context' => 'gofast', 'langcode' => $user_lang))?>
  ...
  <tr>
    <td>
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#f5f5f5" style=" background-color: #f5f5f5; border-bottom: 1px solid;  border-color: #ddd;">
        <tr>  
          <td style="padding-left:15px;">
            <h4 style="margin-top: 10px; margin-bottom: 10px; color: #31708f;"><?php print t('Documents',array(), array('context'=> 'gofast', 'langcode' => $user_lang)); ?></h4>
          </td>
        </tr>
    </table>
    </td>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="padding-left:10px; font-size: 14px; color: #333; padding-top:10px; padding-right: 10px; display: inline-block;">
            <?php echo theme('gofast_retention_notifications_node_retention_list', array('nodes' => $nodes)); ?>
          </td>
        </tr>
      </table>
    </td>
