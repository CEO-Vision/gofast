...
(function() {
    ...
    Annotator.prototype._setupViewer = function() {
      ...
      this.viewer.hide().on("edit", this.onEditAnnotation).on("delete", this.onDeleteAnnotation).addField({
        load: function(field, annotation) {
          if (annotation.text) {
            /*   CEO-VISION PATCH  */
            var new_words = annotation.text.replace(/\n/g, "<br>");
            $(field).html(new_words);
           /*   ------------------- */
          } else {
  ...
  Annotator.Editor = (function(_super) {
    ...
    Editor.prototype.html = "<div class=\"annotator-outer annotator-editor\">\n  <form class=\"annotator-widget\">\n    <ul class=\"annotator-listing\"></ul>\n    <div class=\"annotator-controls\">\n      <a href=\"#cancel\" class=\"annotator-cancel\">" + _t(str_cancel) + "</a>\n<a href=\"#save\" class=\"annotator-save annotator-focus\">" + _t(str_save) + "</a>\n    </div>\n  </form>\n</div>";
  ...
  $(function() {
   ...
   // Annotator.showNotification = notification.show;
     Annotator.showNotification = function(message){
       alert(message);
   }
    ...
    Store.prototype.annotationCreated = function(annotation) {
      ...
      if (__indexOf.call(this.annotations, annotation) < 0) {
        ...
        return this._apiRequest('create', annotation, function(data) {
          ...
          parent.Gofast.loadcomments(parent.Gofast.get('node').id,true);
  ...
  Annotator.Plugin.Permissions = (function(_super) {
      ...
      if(!this.options.privateOnly){
        ...
        if (this.options.showEditPermissionsCheckbox === true) {
          if(this.options.language === 'fr'){
              var str = "Autoriser les autres à <strong>éditer</strong> cette annotation";
          }else{
              var str = "Allow anyone to <strong>edit</strong> this annotation";
          }
          this.annotator.editor.addField({
            type: 'checkbox',
            label: Annotator._t(str),
            load: createCallback('updatePermissionsField', 'update'),
            submit: createCallback('updateAnnotationPermissions', 'update')
          });
        }
        if(this.options.language === 'fr'){
            var str = "Rendre cette annotation privée";
        }else{
            var str = "Make this annotation private";
        }
        this.annotator.editor.addField({
          type: 'checkbox',
          label: Annotator._t(str),
          load: createCallback('updatePrivateField', 'update'),
          submit: createCallback('updateAnnotationPrivate', 'update')
        });
      }
    ...
    Permissions.prototype.updateAnnotationPermissions = function(type, field, annotation) {
      ...
      if ($(field).find('input').is(':checked')) {
        ...
        return annotation.permissions["delete"] = [];
      } else {
        annotation.permissions[type] = [this.options.userId(this.user)];
        return annotation.permissions["delete"] = [this.options.userId(this.user)];
      }
    };

    Permissions.prototype.updatePrivateField = function(action, field, annotation) {
      var input;
      field = $(field).show();
      input = field.find('input').removeAttr('disabled');
      if (!this.authorize('admin', annotation)) {
    ...
    Permissions.prototype.updateAnnotationPrivate = function(type, field, annotation) {
      var dataKey;
      if (!annotation.private) {
        annotation.private = $.extend(true, {}, this.options.private);
      }

      dataKey = type + '-private';
      if ($(field).find('input').is(':checked')) {
        return annotation.private = true;
      } else {
        return annotation.private = false;
      }
    };
...
//@ sourceMappingURL=_annotator-full.map
